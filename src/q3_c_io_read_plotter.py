...
# Read the CSV file
data = pd.read_csv('stats/input/q3_c_io_read.csv', index_col=0)
...
plt.title('RAID I/O Performance Sequential Read Workloads')
plt.legend()
plt.xticks(x_values)
plt.savefig('stats/output/q3_c_io_read.png')
