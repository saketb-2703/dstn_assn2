...
# Read the CSV file
data = pd.read_csv('stats/input/q3_c_io_write.csv', index_col=0)
...
plt.xlabel('Disk')
plt.ylabel('I/Os')
plt.title('RAID I/O Performance for Sequential Write Workloads')
plt.legend()
plt.xticks(x_values)
plt.savefig('stats/output/q3_c_io_write.png')
